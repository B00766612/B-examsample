...
//********************Start Components******************** */
        ...
        Label heading = new Label("<H1>Marty Party Planners</H1>" +"<p/>"
        +"<h3>Please enter the details below and click Book</h3>", com.vaadin.shared.ui.ContentMode.HTML );
        ...
        //people.setWidth(500+"px");
   
        people.addValueChangeListener(e ->{
            
                double x = people.getValue();
                //value.setValue(""+x);
        });
